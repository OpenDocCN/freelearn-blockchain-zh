...
随着越来越多的主机加入，ARPANET 迅速扩张。然而，直到 1971-72 年实施**网络控制协议**（**NCP**）后，ARPANET 用户才能开发应用程序。使用 NCP，用户可以远程访问计算机并发送文件。它充当了传输层，并定义了连接两台计算机的过程。更多阅读：[`www.internet-guide.co.uk/NetworkControlProgram.html`](https://www.internet-guide.co.uk/NetworkControlProgram.html)
